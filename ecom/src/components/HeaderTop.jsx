      ...
      <Container>
        <div className="flex justify-between">
          ...
          <div className="flex items-center gap-5">
            <select className="bg-transparent text-white border-none outline-none cursor-pointer p-1" name="" id="">
              <option className="text-black bg-white " value="">English</option>
              <option className="text-black bg-white" value="">Russian</option>
              <option className="text-black bg-white" value="">Azerbaijan</option>
            </select>
